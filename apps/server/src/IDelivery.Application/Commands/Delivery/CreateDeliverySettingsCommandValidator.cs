...
public sealed class CreateDeliverySettingsCommandValidator : AbstractValidator<CreateDeliverySettingsCommand>
{
    public CreateDeliverySettingsCommandValidator()
    {
        RuleFor(x => x.FeeType)

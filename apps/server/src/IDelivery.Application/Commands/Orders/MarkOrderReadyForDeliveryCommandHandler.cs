...
public sealed class MarkOrderReadyForDeliveryCommandHandler : ICommandHandler<MarkOrderReadyForDeliveryCommand>
{
    ...
    public async Task<Result> Handle(MarkOrderReadyForDeliveryCommand command, CancellationToken cancellationToken = default)
    {
        ...
        var readyResult = order.MarkReadyForDelivery();

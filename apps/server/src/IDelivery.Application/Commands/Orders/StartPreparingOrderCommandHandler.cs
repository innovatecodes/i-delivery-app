...
public sealed class StartPreparingOrderCommandHandler : ICommandHandler<StartPreparingOrderCommand>
{
    ...
    public async Task<Result> Handle(StartPreparingOrderCommand command, CancellationToken cancellationToken = default)
    {
        ...
        var startResult = order.StartPreparing();

...
public sealed class RemoveCustomerAddressCommandHandler : ICommandHandler<RemoveCustomerAddressCommand>
{
    ...
    public async Task<Result> Handle(RemoveCustomerAddressCommand command, CancellationToken cancellationToken = default)
    {
        ...
        var removeResult = customer.RemoveAddress(command.AddressId);
